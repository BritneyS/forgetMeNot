...
//  ForgetMeNot
//
//  Created by Britney Smith on 9/25/18.
...
class EventDatabase {
    var events = [Event(eventTitle: "Christmas", giftRecipient: "Bella", dateOfEventString: "12/25/2018", haveGift: false, eventNotes: "notes"),
                  ...
                  Event(eventTitle: "Mom's birthday", giftRecipient: "Mom", dateOfEventString: "05/07/2019", haveGift: false, eventNotes: "Don't forget!")
    ]
}
